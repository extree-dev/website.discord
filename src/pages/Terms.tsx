...
import styles from '../module_pages/Terms.module.scss';
...
const Terms: React.FC = () => {
    ...
    return (
        <div className={styles.layout}>
            <main className={`${styles.main} ${styles.termsPage}`}>
                ...
                <div className={styles.content}>
                    ...
                    <div className={styles.section}>
                        ...
                        <p>
                            Data is stored securely and is used strictly for moderation purposes. It will not be shared with third parties without consent. You may request access or deletion of your personal data where permitted by law. For more details, see our <Link to="/privacy" className={styles.link}>Privacy Policy</Link>.
                        </p>
                    </div>
